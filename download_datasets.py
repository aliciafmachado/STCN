...
parser.add_argument('--datasets', default='davis', choices=['davis', 'youtube', 'static', 'all'])
...
# Static data
if datasets == 'static' or datasets == 'all':
...
if datasets == 'davis' or datasets == 'all':
...
# YouTubeVOS
if datasets == 'youtube' or datasets == 'all':
